...
public class GeneratePdfReport {
	...
	public static ByteArrayInputStream planningReport(List<Planning> modules) {
		...
		for (DateFormatee dateFormatee : listDateF) {
			...
			// System.out.println(dateFormatee.toString());
		}
		int indice = 0;
		...
		for (int j = 0; j < modules.size(); j++) {
			...
			for (int i = 1; i <= duree; i++) {
				...
				if (listeJourFormation.get(indice).getJour().equals("sam")
					...
					// listeJourFormation.get(indice).setMatiere("");
					// listeJourFormation.get(indice).setFormateur("");
					// listeJourFormation.get(indice).setTitre("");
					weekend = true;
		...
		// listeJourFormation.add(new jourFormation("Janvier", "jeu", "24", "UML",
		// "Olivier", "Formateur JEE"));
		// listeJourFormation.add(new jourFormation("Janvier", "ven", "25", "UML",
		// "Olivier", "Formateur JEE"));
		// listeJourFormation.add(new jourFormation("Janvier", "sam", "26", "", "",
		// ""));
		// listeJourFormation.add(new jourFormation("Janvier", "dim", "27", "", "",
		// ""));
		// listeJourFormation.add(new jourFormation("Janvier", "lun", "28", "Algo",
		// "Olivier", "Formateur JEE"));
		// listeJourFormation.add(new jourFormation("Janvier", "mar", "29", "Algo",
		// "Olivier", "Formateur JEE"));
		// listeJourFormation.add(new jourFormation("Janvier", "mer", "30", "Algo",
		// "Olivier", "Formateur JEE"));
		// listeJourFormation.add(new jourFormation("Janvier", "jeu", "31", "Java",
		// "Mourad", "Formateur JEE"));
		// listeJourFormation.add(new jourFormation("Février", "ven", "01", "Java",
		// "Mourad", "Formateur JEE"));
		// listeJourFormation.add(new jourFormation("Février", "sam", "02", "", "",
		// ""));
		// listeJourFormation.add(new jourFormation("Février", "dim", "03", "", "",
		// ""));
		// listeJourFormation.add(new jourFormation("Février", "lun", "04", "Java",
		// "Mourad", "Formateur JEE"));
		// listeJourFormation.add(new jourFormation("Février", "mar", "05", "Java",
		// "Mourad", "Formateur JEE"));
		// listeJourFormation.add(new jourFormation("Février", "mer", "06", "POO",
		// "Mourad", "Formateur JEE"));
		// listeJourFormation.add(new jourFormation("Février", "jeu", "07", "POO",
		// "Mourad", "Formateur JEE"));
		// List<String> lesMois = new ArrayList<String>();
		// lesMois.add("Janvier");lesMois.add("Février");lesMois.add("Mars");
		//
		// List<String> lesJours = new ArrayList<String>();
		// lesJours.add("lun");lesJours.add("mar");lesJours.add("mer");lesJours.add("jeu");
		// lesJours.add("ven");lesJours.add("sam");lesJours.add("dim");
		//
		// String dateDebut = "jeudi 18 janvier"; String dateFin = "vendredi 23 mars";
		// int duree = 5;
		// int dureeMatiere = 3;
		...
		try {
			...
			while (i < listeJourFormation.size()) {
				...
				for (int j = 0; j <= cpt; j++) {
					...
					// if(nbLiMat == 0) {
					// System.out.println("la matiere est sur une seule ligne");
					// cell = new PdfPCell(new Phrase(listeJourFormation.get(j +
					// indTab).getJour()));
					// mytable.addCell(cell);
					// cell = new PdfPCell(new Phrase(listeJourFormation.get(j +
					// indTab).getIndiceJour()));
					// mytable.addCell(cell);
					// cell = new PdfPCell(new Phrase(listeJourFormation.get(j +
					// indTab).getMatiere()));
					// mytable.addCell(cell);
		...
		DocumentException ex) {
			...
			Logger.getLogger(GeneratePdfReport.class.getName()).log(Level.SEVERE, null, ex); // à revoire
		}
